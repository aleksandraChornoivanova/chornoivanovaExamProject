...
public class SignInWithFacebook {
    ...
    public void validSignInWithFacebook (){
        webDriver.manage().window().maximize();
        webDriver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
        webDriver.get("https://nustay.com/");
        webDriver.findElement(By.xpath(".//button[@onclick=\"SignupService.Signin();\"]")).click();
        webDriver.findElement(By.xpath(".//button[@id=\"btnFacebookSignIn\"]")).click();
        webDriver.findElement(By.xpath(".//input[@id=\"email\"]")).sendKeys("achornoivanova@gmail.com");
        webDriver.findElement(By.xpath(".//input[@id=\"pass\"]")).sendKeys("cfif1609");
